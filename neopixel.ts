...
namespace CO2 {
            ...
            if (v == 0) {
                ...
                for (let i = 0; i < n; ++i) {
                    if (i <= v) {
                        ...
                        this.setPixelColor(i, CO2.rgb(b, 0, 255 - b));
                    }
     ...
     */
    //% blockId="neopixel_create" block="NeoPixel leds as %mode"
    //% weight=90 blockGap=8
    //% parts="neopixel"
    //% trackArgs=0,2
    //% blockSetVariable=strip
    export function create(pin: 12, numleds: 7, mode: NeoPixelMode): Strip {
        let strip = new Strip();
